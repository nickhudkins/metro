...
export type MutableInternalDependency = Omit<
  DependencyData,
  keyof {locs: Array<BabelSourceLocation>; index: number; name: string}
> & {locs: Array<BabelSourceLocation>; index: number; name: string};
...
export type State = {
  ...
  unstable_isESMImportAtSource:
    | null
    | undefined
    | (($$PARAM_0$$: BabelSourceLocation) => boolean);
};
